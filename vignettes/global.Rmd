...
# Packages
I would normally load packages with `pacman::p_load` but I had some trouble with this
when deploying to shiny 
...
library(highcharter)  ## for most charts ## remotes::install_github("jbkunst/highcharter")
library(plotly) ## for the active contacts snake plot. highcharter renders this plot too slowly
library(shiny)
library(shinyjs)
