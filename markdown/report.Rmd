...
contacts_under_surveillance_per_admin_1_over_time_text(contacts_df_long,
                                                      todays_date,
                                                      report_format)
update_rmd_progress()
```
...
contacts_under_surveillance_per_admin_1_over_time_bar_chart(contacts_df_long,
                                                           todays_date,
                                                           report_format)
update_rmd_progress()
```
...
contacts_under_surveillance_per_admin_1_over_time_bar_chart_relative(contacts_df_long,
                                                                    todays_date,
                                                                    report_format)
update_rmd_progress()
```
